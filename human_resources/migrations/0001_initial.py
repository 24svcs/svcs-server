...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='position',
            constraint=models.UniqueConstraint(fields=('organization', 'title'), name='unique_position_per_organization'),
        ),
        migrations.AddConstraint(
            model_name='position',
        ...
        migrations.AddConstraint(
            model_name='employmentdetails',
            constraint=models.CheckConstraint(condition=models.Q(('shift_end__gt', models.F('shift_start'))), name='shift_end_after_start'),
        ),
        migrations.AddConstraint(
            model_name='employmentdetails',
